...
{
    kstd::printf("[VMM] Getting physical address of addr %llx.\n", addr);
    ...
    kstd::printf("[VMM] PML4e address: %llx.\n", pml4e);
    ...
    kstd::printf("[VMM] PDPe address: %llx\n", pdpe);
    ...
    kstd::printf("[VMM] PDe address: %llx\n", pde);
    ...
    kstd::printf("[VMM] PTe address: %llx\n", pte);

    kstd::printf("[VMM] Physical address: %llx\n", pte[va.pte].phys_ptr << 12);
