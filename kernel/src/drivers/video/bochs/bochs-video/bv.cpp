...
static driver_status_t bv_set_res(
        [[maybe_unused]] driver_handle_t* bv_handle,
...
static driver_status_t bv_gfx_create_render_object(
        [[maybe_unused]] driver_handle_t* gfx_handle,
        [[maybe_unused]] const GfxCreateRenderObjectReq* gfx_render_object_request
)
{
    return DS_SUCCESS;
}
...
static driver_status_t bv_ioctl(
        ...
        [[maybe_unused]] char * bv_ioctl_resp
)
{
    ...
    switch (bv_ioctl)
    {
        ...
        case GPU_CREATE_RENDER_OBJECT:
            return bv_gfx_create_render_object(
                    bv_handle,
                    reinterpret_cast<const GfxCreateRenderObjectReq*>(bv_ioctl_buf)
                    );
        default:
            return DS_FAILURE;
    }
