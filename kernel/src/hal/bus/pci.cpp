...
void pci_walk_bus([[maybe_unused]] size_t bus_idx)
{
...
inline void pcie_call_driver_header_1([[maybe_unused]] acpi_mcfg_base_address_allocation_structure* baas, uint32_t* data, [[maybe_unused]] size_t bus, [[maybe_unused]] size_t slot, [[maybe_unused]] size_t function)
{
    [[maybe_unused]] pci_dev_hdr_common* hdr = reinterpret_cast<pci_dev_hdr_common*>(data);
    //kstd::printf("Unsupported hdr type: %hx\n", hdr->header_type);
}

inline void pcie_call_driver_header_2([[maybe_unused]] acpi_mcfg_base_address_allocation_structure* baas, uint32_t* data, [[maybe_unused]] size_t bus, [[maybe_unused]] size_t slot, [[maybe_unused]] size_t function)
{
[[maybe_unused]] pci_dev_hdr_common* hdr = reinterpret_cast<pci_dev_hdr_common*>(data);
    //kstd::printf("Unsupported hdr type: %hx\n", hdr->header_type);
}
