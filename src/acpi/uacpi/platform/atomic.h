...
#define UACPI_MAKE_MSVC_CMPXCHG(width, type, suffix)                                                                   \
    static inline int uacpi_do_atomic_cmpxchg##width(type volatile *ptr, type volatile *expected, type desired)        \
    {                                                                                                                  \
        type current;                                                                                                  \
                                                                                                                       \
...
#define UACPI_MSVC_CMPXCHG_INVOKE(ptr, expected, desired, width, type)                                                 \
    uacpi_do_atomic_cmpxchg##width((type volatile *)ptr, (type volatile *)expected, desired)

#define UACPI_MSVC_ATOMIC_STORE(ptr, value, type, width)                                                               \
    _InterlockedExchange##width((type volatile *)(ptr), (type)(value))

#define UACPI_MSVC_ATOMIC_LOAD(ptr, type, width) _InterlockedOr##width((type volatile *)(ptr), 0)

#define UACPI_MSVC_ATOMIC_INC(ptr, type, width) _InterlockedIncrement##width((type volatile *)(ptr))

#define UACPI_MSVC_ATOMIC_DEC(ptr, type, width) _InterlockedDecrement##width((type volatile *)(ptr))

UACPI_MAKE_MSVC_CMPXCHG(64, __int64, 64)
UACPI_MAKE_MSVC_CMPXCHG(32, long, )
UACPI_MAKE_MSVC_CMPXCHG(16, short, 16)

#define uacpi_atomic_cmpxchg16(ptr, expected, desired) UACPI_MSVC_CMPXCHG_INVOKE(ptr, expected, desired, 16, short)

#define uacpi_atomic_cmpxchg32(ptr, expected, desired) UACPI_MSVC_CMPXCHG_INVOKE(ptr, expected, desired, 32, long)

#define uacpi_atomic_cmpxchg64(ptr, expected, desired) UACPI_MSVC_CMPXCHG_INVOKE(ptr, expected, desired, 64, __int64)
