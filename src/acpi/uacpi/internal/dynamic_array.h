...
#define DYNAMIC_ARRAY_WITH_INLINE_STORAGE_EXPORTS(name, type, prefix)                                                  \
    ...
    prefix type *name##_last(struct name *arr) prefix void name##_clear(struct name *arr);
...
#define DYNAMIC_ARRAY_WITH_INLINE_STORAGE_IMPL(name, type, prefix)                                                     \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            {                                                                                                          \
                ...
                {                                                                                                      \
                    uacpi_memcpy(new_buf, arr->dynamic_storage, dynamic_size *type_size);                              \
                }                                                                                                      \
    ...
    {                                                                                                                  \
        uacpi_free(arr->dynamic_storage, arr->dynamic_capacity * sizeof(*arr->dynamic_storage));                       \
