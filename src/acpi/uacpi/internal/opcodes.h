...
#define UACPI_UNRESOLVED_NAME_STRING_OP(character, code)                                                               \
    UACPI_OP(UACPI_InternalOpUnresolvedNameString_##character, code,                                                   \
             ...
             UACPI_OP_PROPERTY_SIMPLE_NAME | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TERM_ARG)
...
#define UACPI_BUILD_LOCAL_OR_ARG_OP(prefix, base, offset)                                                              \
    UACPI_OP(prefix##offset##Op, base + offset,                                                                        \
             ...
             UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SIMPLE_NAME)
...
#define UACPI_ENUMERATE_OPCODES                                                                                        \
    ...
    UACPI_OP(IndexOp, 0x88,                                                                                            \
             ...
             UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_SIMPLE_NAME)                 \
    UACPI_OP(MatchOp, 0x89,                                                                                            \
             {                                                                                                         \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                              \
                 UACPI_PARSE_OP_TYPECHECK,                                                                             \
                 UACPI_OBJECT_PACKAGE,                                                                                 \
    ...
    UACPI_OP(NoopOp, 0xA3,                                                                                             \
             {                                                                                                         \
                 UACPI_PARSE_OP_END,                                                                                   \
             })                                                                                                        \
    UACPI_OP(ReturnOp, 0xA4,                                                                                           \
             {                                                                                                         \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                              \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             })                                                                                                        \
    UACPI_OP(BreakOp, 0xA5,                                                                                            \
             {                                                                                                         \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             })                                                                                                        \
...
#define UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(name, code, type, ...)                                                       \
    UACPI_OP(name##Op, UACPI_EXT_OP(code),                                                                             \
             {                                                                                                         \
                 UACPI_PARSE_OP_TRACKED_PKGLEN,                                                                        \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,                                                     \
                 ##__VA_ARGS__,                                                                                        \
...
#define UACPI_BUILD_TO_FROM_BCD(type, code)                                                                            \
    UACPI_OP(type##BCDOp, UACPI_EXT_OP(code),                                                                          \
             {                                                                                                         \
                 UACPI_PARSE_OP_OPERAND,                                                                               \
                 UACPI_PARSE_OP_TARGET,                                                                                \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                    \
...
#define UACPI_ENUMERATE_EXT_OPCODES                                                                                    \
    UACPI_OP(ReservedExtOp, UACPI_EXT_OP(0x00),                                                                        \
             {                                                                                                         \
                 UACPI_PARSE_OP_BAD_OPCODE,                                                                            \
             })                                                                                                        \
    UACPI_OP(MutexOp, UACPI_EXT_OP(0x01),                                                                              \
             {                                                                                                         \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,                                                     \
                 UACPI_PARSE_OP_LOAD_IMM,                                                                              \
                 1,                                                                                                    \
    ...
    UACPI_OP(EventOp, UACPI_EXT_OP(0x02),                                                                              \
             {                                                                                                         \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,                                                     \
                 UACPI_PARSE_OP_SKIP_WITH_WARN_IF_NULL,                                                                \
                 0,                                                                                                    \
    ...
    UACPI_OP(CondRefOfOp, UACPI_EXT_OP(0x12),                                                                          \
             {                                                                                                         \
                 UACPI_PARSE_OP_SUPERNAME_OR_UNRESOLVED,                                                               \
                 UACPI_PARSE_OP_TARGET,                                                                                \
                 UACPI_PARSE_OP_IF_NULL,                                                                               \
             ...
             UACPI_OP_PROPERTY_TERM_ARG)                                                                               \
    UACPI_DO_BUILD_BUFFER_FIELD_OP(Create, UACPI_EXT_OP(0x13), 3, UACPI_PARSE_OP_OPERAND)                              \
    UACPI_OUT_OF_LINE_OP(LoadTableOp, UACPI_EXT_OP(0x1F), uacpi_load_table_op_decode_ops,                              \
    ...
    UACPI_OUT_OF_LINE_OP(LoadOp, UACPI_EXT_OP(0x20), uacpi_load_op_decode_ops,                                         \
                         UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_OUT_OF_LINE)                                   \
    UACPI_OP(StallOp, UACPI_EXT_OP(0x21),                                                                              \
             {                                                                                                         \
                 UACPI_PARSE_OP_OPERAND,                                                                               \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             })                                                                                                        \
    UACPI_OP(SleepOp, UACPI_EXT_OP(0x22),                                                                              \
             {                                                                                                         \
                 UACPI_PARSE_OP_OPERAND,                                                                               \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             })                                                                                                        \
    UACPI_OP(AcquireOp, UACPI_EXT_OP(0x23),                                                                            \
             {                                                                                                         \
                 UACPI_PARSE_OP_SUPERNAME,                                                                             \
                 UACPI_PARSE_OP_LOAD_IMM,                                                                              \
                 2,                                                                                                    \
             ...
             UACPI_OP_PROPERTY_TERM_ARG)                                                                               \
    UACPI_OP(SignalOp, UACPI_EXT_OP(0x24),                                                                             \
             {                                                                                                         \
                 UACPI_PARSE_OP_SUPERNAME,                                                                             \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             })                                                                                                        \
    UACPI_OP(WaitOp, UACPI_EXT_OP(0x25),                                                                               \
             {                                                                                                         \
                 UACPI_PARSE_OP_SUPERNAME,                                                                             \
                 UACPI_PARSE_OP_OPERAND,                                                                               \
                 UACPI_PARSE_OP_LOAD_TRUE_OBJECT,                                                                      \
             ...
             UACPI_OP_PROPERTY_TERM_ARG)                                                                               \
    UACPI_OP(ResetOp, UACPI_EXT_OP(0x26),                                                                              \
             {                                                                                                         \
                 UACPI_PARSE_OP_SUPERNAME,                                                                             \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             })                                                                                                        \
    UACPI_OP(ReleaseOp, UACPI_EXT_OP(0x27),                                                                            \
             {                                                                                                         \
                 UACPI_PARSE_OP_SUPERNAME,                                                                             \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             })                                                                                                        \
    ...
    UACPI_OP(RevisionOp, UACPI_EXT_OP(0x30),                                                                           \
             {                                                                                                         \
                 UACPI_PARSE_OP_LOAD_INLINE_IMM_AS_OBJECT,                                                             \
                 0x01,                                                                                                 \
                 0x00,                                                                                                 \
    ...
    UACPI_OP(DebugOp, UACPI_EXT_OP(0x31),                                                                              \
             ...
             UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TARGET)                      \
    UACPI_OP(FatalOp, UACPI_EXT_OP(0x32),                                                                              \
             {                                                                                                         \
                 UACPI_PARSE_OP_LOAD_IMM,                                                                              \
                 1,                                                                                                    \
                 UACPI_PARSE_OP_LOAD_IMM,                                                                              \
    ...
    UACPI_OP(TimerOp, UACPI_EXT_OP(0x33),                                                                              \
             {                                                                                                         \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                    \
                 UACPI_OBJECT_INTEGER,                                                                                 \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                        \
             ...
             UACPI_OP_PROPERTY_TERM_ARG)                                                                               \
    UACPI_OP(OpRegionOp, UACPI_EXT_OP(0x80),                                                                           \
             {                                                                                                         \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,                                                     \
                 UACPI_PARSE_OP_LOAD_IMM,                                                                              \
                 1,                                                                                                    \
    ...
    UACPI_OUT_OF_LINE_OP(FieldOp, UACPI_EXT_OP(0x81), uacpi_field_op_decode_ops, UACPI_OP_PROPERTY_OUT_OF_LINE)        \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(Device, 0x82, UACPI_OBJECT_DEVICE)                                               \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(Processor, 0x83, UACPI_OBJECT_PROCESSOR, UACPI_PARSE_OP_LOAD_IMM, 1,             \
                                      UACPI_PARSE_OP_LOAD_IMM, 4, UACPI_PARSE_OP_LOAD_IMM, 1)                          \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(PowerRes, 0x84, UACPI_OBJECT_POWER_RESOURCE, UACPI_PARSE_OP_LOAD_IMM, 1,         \
                                      UACPI_PARSE_OP_LOAD_IMM, 2)                                                      \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(ThermalZone, 0x85, UACPI_OBJECT_THERMAL_ZONE)                                    \
    UACPI_OUT_OF_LINE_OP(IndexFieldOp, UACPI_EXT_OP(0x86), uacpi_index_field_op_decode_ops,                            \
                         UACPI_OP_PROPERTY_OUT_OF_LINE)                                                                \
    UACPI_OUT_OF_LINE_OP(BankFieldOp, UACPI_EXT_OP(0x87), uacpi_bank_field_op_decode_ops,                              \
                         UACPI_OP_PROPERTY_OUT_OF_LINE)                                                                \
    UACPI_OP(DataRegionOp, UACPI_EXT_OP(0x88),                                                                         \
             {                                                                                                         \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,                                                     \
                 UACPI_PARSE_OP_STRING,                                                                                \
                 UACPI_PARSE_OP_STRING,                                                                                \
