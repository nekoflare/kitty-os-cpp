...
#define UACPI_ALWAYS_ERROR_FOR_REDUCED_HARDWARE(fn) UACPI_MAKE_STUB_FOR_REDUCED_HARDWARE(fn, UACPI_STATUS_COMPILED_OUT)
#define UACPI_ALWAYS_OK_FOR_REDUCED_HARDWARE(fn) UACPI_MAKE_STUB_FOR_REDUCED_HARDWARE(fn, UACPI_STATUS_OK)
#else
...
#define UACPI_FLAG_PROACTIVE_TBL_CSUM (1ull << 5)
     ...
     */
    uacpi_status uacpi_eval_integer(uacpi_namespace_node *parent, const uacpi_char *path,
     ...
     */
    uacpi_status uacpi_eval_package(uacpi_namespace_node *parent, const uacpi_char *path,
                                    const uacpi_object_array *args, uacpi_object **ret);
    ...
    UACPI_ALWAYS_ERROR_FOR_REDUCED_HARDWARE(uacpi_status uacpi_leave_acpi_mode(void))
